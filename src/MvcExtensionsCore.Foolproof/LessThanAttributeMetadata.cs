...
namespace MvcExtensionsCore
{
    ...
    /// <summary>
    /// Represents a class to store less-then validation metadata.
    /// </summary>
    public class LessThanAttributeMetadata : IsAttributeMetadata
    {
        /// <summary>
        ...
        {
            return new LessThanAttribute(OtherProperty);
        }
    }
}