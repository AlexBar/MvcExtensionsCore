...
namespace MvcExtensionsCore
{
    ...
    public static class NotEqualToModelMetadataItemBuilderExtensions
    {
        ...
        /// <returns></returns>
        public static ModelMetadataItemBuilder<TValue> NotEqualTo<TValue>(this ModelMetadataItemBuilder<TValue> self, string otherProperty, bool passOnNull)
        {
            return NotEqualTo(self, otherProperty, passOnNull, null, null, null);
        }
        ...
        /// <param name="self">The instance.</param>
        /// <returns></returns>
        public static ModelMetadataItemBuilder<TValue> NotEqualTo<TValue>(this ModelMetadataItemBuilder<TValue> self, string otherProperty, bool passOnNull, string errorMessage)
        {
            return NotEqualTo(self, otherProperty, passOnNull, () => errorMessage);
        }
        ...
        /// <param name="errorMessageResourceName">Name of the error message resource.</param>
        /// <returns></returns>
        public static ModelMetadataItemBuilder<TValue> NotEqualTo<TValue>(this ModelMetadataItemBuilder<TValue> self, string otherProperty, bool passOnNull, Type errorMessageResourceType, string errorMessageResourceName)
        {
            return NotEqualTo(self, otherProperty, passOnNull, null, errorMessageResourceType, errorMessageResourceName);
        }
        ...
        /// <param name="errorMessageResourceName">Name of the error message resource.</param>
        /// <returns></returns>
        private static ModelMetadataItemBuilder<TValue> NotEqualTo<TValue>(this ModelMetadataItemBuilder<TValue> self, string otherProperty, bool passOnNull, Func<string> errorMessage, Type errorMessageResourceType, string errorMessageResourceName)
        {
            self.AddAction(m =>
            {
                var validation = m.GetValidationOrCreateNew<NotEqualToAttributeMetadata>();
