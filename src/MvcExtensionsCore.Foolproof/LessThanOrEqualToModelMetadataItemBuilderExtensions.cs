...
namespace MvcExtensionsCore
{
    ...
    /// <summary>
    /// Adds validation for <see cref="LessThanOrEqualToAttribute"/>
    /// </summary>
    public static class LessThanOrEqualToModelMetadataItemBuilderExtensions
    {
        /// <summary>
        ...
        private static ModelMetadataItemBuilder<TValue> LessThanOrEqualTo<TValue>(this ModelMetadataItemBuilder<TValue> self, string otherProperty, bool passOnNull, Func<string> errorMessage, Type errorMessageResourceType, string errorMessageResourceName)
        {
            self.AddAction(m =>
            {
                var validation = m.GetValidationOrCreateNew<LessThanOrEqualToAttributeMetadata>();
