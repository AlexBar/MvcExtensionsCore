...
namespace MvcExtensionsCore
{
    ...
    public class ModelMetadataRegistry : IModelMetadataRegistry
    {
        ...
        private readonly IDictionary<Type, IModelMetadataConfiguration> configurations = new Dictionary<Type, IModelMetadataConfiguration>();
        ...
        public virtual ModelMetadataItem GetModelPropertyMetadata([NotNull] Type modelType, string propertyName)
        {
            ...
            var item = mappings.GetOrAdd(modelType, CreateModelMetadataRegistryItem);
